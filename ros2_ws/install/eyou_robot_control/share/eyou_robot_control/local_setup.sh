...
: ${AMENT_CURRENT_PREFIX:="/app/ros2_ws/install/eyou_robot_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/eyou_robot_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/eyou_robot_control/environment/path.sh"
